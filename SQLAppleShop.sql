CREATE DATABASE AppleShopOnline
USE AppleShopOnline
...
(
	MaDoiTuong VARCHAR(10) NOT NULL PRIMARY KEY,
...
CREATE TABLE KichCo
(
	MaKichCo VARCHAR(10) NOT NULL PRIMARY KEY,
...
(
	...
	MaDoiTuong VARCHAR(10) FOREIGN KEY REFERENCES DoiTuong(MaDoiTuong) NULL,
	MaTheLoai VARCHAR(10) FOREIGN KEY REFERENCES TheLoai(MaTheLoai) NULL,
	MaKichCo VARCHAR(10) FOREIGN KEY REFERENCES KichCo(MaKichCo) NULL,
	MaChatLieu VARCHAR(10) FOREIGN KEY REFERENCES ChatLieu(MaChatLieu) NULL,
